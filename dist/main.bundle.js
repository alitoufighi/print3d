...
var LastPrintsComponent = (function () {
    function LastPrintsComponent(router, httpService, snackBar, progressService) {
        this.router = router;
        this.httpService = httpService;
        this.snackBar = snackBar;
        this.progressService = progressService;
        this.printData = new __WEBPACK_IMPORTED_MODULE_3__node_modules_angular_material__["r" /* MatTableDataSource */]();
    }
    LastPrintsComponent.prototype.ngOnInit = function () {
        this.getLastPrintedFiles(); // TODO: might need scrolling ...
    };
