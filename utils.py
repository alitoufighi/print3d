...
#                         # nothing to return
#                         while self.machine_serial.readline() != b'ok\n':
#                             pass
#                         first_done = True
#
#                     elif self.__Gcodes_return[0] == 1:
#                         # retrun temp
#                         data = self.machine_serial.readline()
#                         splited = data.split()
...
#         """
#         sub_usb_dir = subprocess.Popen(['ls', '/media/alitou'], stdout=subprocess.PIPE).communicate()[0]
